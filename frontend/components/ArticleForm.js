...
export default function ArticleForm(props) {
  ...
  useEffect(() => {
    !currentArticle ? setValues(initialFormValues): setValues(currentArticle)
    // ✨ implement
  ...
  return (
    ...
    <form id="form" onSubmit={onSubmit}>
      ...
      <div className="button-group">
        <button disabled={values.title.trim() < 1 || values.text.trim().length < 1 || values.topic.length < 1} id="submitArticle">Submit</button>
